...
const WHATSAPP_NUMBER = "34610775140"

export async function WhatsAppFloat() {
  const t = await getTranslations("whatsapp")

  // Prefilled Spanish message: the recipient greets visitors on the
  // (Spanish-first) site; visitors can delete it before sending.
