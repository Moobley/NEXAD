...
export async function BarberProblem() {
  const t = await getTranslations("projects.barber.lab.problem")
        ...
        <div className="grid gap-12 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="lg:col-span-7">
            ...
            <Reveal variant="fade-up" delay={200}>
              <p className="mt-8 font-serif text-xl italic leading-snug md:text-2xl">
                {t("closing")}
              </p>
            </Reveal>
          </div>
